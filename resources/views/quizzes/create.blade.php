                    ...
                    <div class="card mb-3 question-card">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <textarea name="questions[0][question]" class="form-control question-text" rows="3" placeholder="Masukkan pertanyaan"></textarea>
                            </div>
                            ...
                            <div class="options-container">
                                <div class="mb-3 option-group">
                                    <div class="input-group">
                                        <input type="text" name="questions[0][options][]" class="form-control" placeholder="Opsi A">
                                        <div class="input-group-text">
                                            <input class="form-check-input mt-0 option-correct" type="radio" name="questions[0][correct]" value="0" checked>
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-3 option-group">
                                    <div class="input-group">
                                        <input type="text" name="questions[0][options][]" class="form-control" placeholder="Opsi B">
                                        <div class="input-group-text">
                                            <input class="form-check-input mt-0 option-correct" type="radio" name="questions[0][correct]" value="1">
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-3 option-group">
                                    <div class="input-group">
                                        <input type="text" name="questions[0][options][]" class="form-control" placeholder="Opsi C">
                                        <div class="input-group-text">
                                            <input class="form-check-input mt-0 option-correct" type="radio" name="questions[0][correct]" value="2">
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-3 option-group">
                                    <div class="input-group">
                                        <input type="text" name="questions[0][options][]" class="form-control" placeholder="Opsi D">
                                        <div class="input-group-text">
                                            <input class="form-check-input mt-0 option-correct" type="radio" name="questions[0][correct]" value="3">
                                        </div>
                                    </div>
                                </div>
                            </div>
